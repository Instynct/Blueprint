...
$('.newsletter-form .wpcf7-form p:first-of-type').append('<img class="input-underline" src="../wp-content/themes/snoros/dist/svg/snoros-apropos-separateur.svg" alt="Séparateur">');
